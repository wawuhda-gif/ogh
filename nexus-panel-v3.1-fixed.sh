...
header(){
  ...
  echo -e "${C7}  ║   ╚═════╝  ╚═════╝ ╚═╝  ╚═╝    ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝${NC}"
  echo -e "${C1}  ╠══════════════════════════════════════════════════════════╣${NC}"
  echo -e "${C2}  ║         ★  N E X U S   V P S   P A N E L  ★            ║${NC}"
  echo -e "${C1}  ╚══════════════════════════════════════════════════════════╝${NC}"
  echo ""
  if [[ "$TEMA" == "rainbow" ]]; then
    rainbow "    ⚡  SSH • UDP • VMess • VLess • Trojan  |  v3.1  ⚡"
    rainbow "         Powered by Xray-core ${XRAY_VER}              "
  else
    echo -e "  ${AC}  ⚡  SSH • UDP • VMess • VLess • Trojan  |  v3.1  ⚡${NC}"
    echo -e "  ${SC}       Powered by Xray-core ${XRAY_VER}              ${NC}"
  fi
...
EOF
  ...
  # Enable xray tapi jangan langsung start jika baru pertama kali install
  # Gunakan start bukan enable --now agar bisa cek status dulu
  ...
  if systemctl is-active --quiet xray; then
    ...
    err "Xray gagal start! Cek log: journalctl -u xray -n 30"
    warn "Coba cek config: xray -test -config $XRAY_CFG"
  fi
}
...
menu_xray(){
  while true; do
    ...
    echo -e "  ${D}╔════════════════════════════════════════════════════════════╗${NC}"
    echo -e "  ${D}║${NC}  ${CB}◈  nTLS / Plain (Tanpa Enkripsi)${NC}                          ${D}║${NC}"
    echo -e "  ${D}╠════════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W}01${R}]${NC} ${W}Tambah VMess nTLS  WS  :8443${NC}  ${D}│${NC}  ${M}[${W}10${M}]${NC} ${W}VMess TLS  WS  :8553  ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W}02${R}]${NC} ${W}Tambah VMess nTLS  TCP :1194${NC}  ${D}│${NC}  ${M}[${W}11${M}]${NC} ${W}VMess TLS  TCP :2083  ${D}║${NC}"
    echo -e "  ${D}╠════════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${O}[${W}03${O}]${NC} ${W}Tambah VLess nTLS  WS  :8444${NC}  ${D}│${NC}  ${Y}[${W}12${Y}]${NC} ${W}VLess TLS  WS  :8554  ${D}║${NC}"
    echo -e "  ${D}╠════════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${CB}[${W}04${CB}]${NC} ${W}Tambah Trojan nTLS TCP :8445${NC}  ${D}│${NC}  ${GB}[${W}13${GB}]${NC} ${W}Trojan TLS TCP :8446  ${D}║${NC}"
    echo -e "  ${D}╠════════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${D}[${W}05${D}]${NC} Daftar User Xray      ${D}│${NC}  ${D}[${W}14${D}]${NC} Hapus User Xray       ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${D}[${W}06${D}]${NC} Info VMess nTLS       ${D}│${NC}  ${D}[${W}15${D}]${NC} Info VMess TLS        ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${D}[${W}07${D}]${NC} Info VLess nTLS       ${D}│${NC}  ${D}[${W}16${D}]${NC} Info VLess TLS        ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${D}[${W}08${D}]${NC} Info Trojan nTLS      ${D}│${NC}  ${D}[${W}17${D}]${NC} Info Trojan TLS       ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${D}[${W}09${D}]${NC} Ubah Port Xray        ${D}│${NC}  ${D}[${W}18${D}]${NC} Renew SSL Cert        ${D}║${NC}"
    echo -e "  ${D}╠════════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${D}[${W}19${D}]${NC} Restart Xray   ${D}[${W}20${D}]${NC} Lihat Config   ${D}[${W}21${D}]${NC} Log Xray ${D}║${NC}"
    echo -e "  ${D}╠════════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${M}[${W}00${M}]${NC} ${W}Kembali ke Menu Utama                                 ${D}║${NC}"
    echo -e "  ${D}╚════════════════════════════════════════════════════════════╝${NC}"
    echo ""
...
menu_ssh(){
  while true; do
    ...
    echo -e "  ${D}╔══════════════════════════╦═══════════════════════════════╗${NC}"
    echo -e "  ${D}║${NC}  ${CB}Total Akun :${NC} ${Y}${TOT}${NC}           ${D}║${NC}  ${CB}◈  Manajemen SSH          ${D}║${NC}"
    echo -e "  ${D}╠══════════════════════════╬═══════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W}01${R}]${NC} Buat Akun SSH      ${D}║${NC}  ${R}[${W}06${R}]${NC} Ganti Password        ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W}02${R}]${NC} Hapus Akun SSH     ${D}║${NC}  ${R}[${W}07${R}]${NC} Cek User Online       ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W}03${R}]${NC} Daftar Akun SSH    ${D}║${NC}  ${R}[${W}08${R}]${NC} Kick User             ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W}04${R}]${NC} Info Akun SSH      ${D}║${NC}  ${R}[${W}09${R}]${NC} Lock Akun             ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W}05${R}]${NC} Perpanjang Akun    ${D}║${NC}  ${R}[${W}10${R}]${NC} Unlock Akun           ${D}║${NC}"
    echo -e "  ${D}╠══════════════════════════╩═══════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W}00${R}]${NC} ${W}Kembali ke Menu Utama                                ${D}║${NC}"
    echo -e "  ${D}╚══════════════════════════════════════════════════════════╝${NC}"
    echo ""
...
menu_setting(){
  while true; do
    ...
    echo -e "  ${D}╔══════════════════════════════════════════════════════════╗${NC}"
    echo -e "  ${D}║${NC}  ${Y}◈  Pengaturan Panel                                    ${D}║${NC}"
    echo -e "  ${D}╠══════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${R}[1]${NC} Pilih Tema     ${R}[4]${NC} Renew SSL     ${R}[7]${NC} Auto-Kill    ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${R}[2]${NC} Port SSH       ${R}[5]${NC} Setup Domain  ${R}[8]${NC} Backup       ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${R}[3]${NC} Port Dropbear  ${R}[6]${NC} Auto-Reboot   ${R}[9]${NC} Restore      ${D}║${NC}"
    echo -e "  ${D}╠══════════════════════════════════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${R}[0]${NC} ${W}Kembali                                               ${D}║${NC}"
    echo -e "  ${D}╚══════════════════════════════════════════════════════════╝${NC}"
    echo ""
    read -rp "$(echo -e "  ${Y}Pilih : ${NC}")" CH
    case "$CH" in
      1) menu_tema ;;
      2) read -rp "  Port SSH baru (misal: 22 atau 2222): " P
         if [[ ! "$P" =~ ^[0-9]+$ || "$P" -lt 1 || "$P" -gt 65535 ]]; then
           err "Port tidak valid! Harus angka 1-65535."; press_enter
         else
           local SSHD_BAK="/etc/ssh/sshd_config.bak.$(date +%s)"
           cp /etc/ssh/sshd_config "$SSHD_BAK" 2>/dev/null
           sed -i "s/^#\?Port [0-9]*/Port $P/" /etc/ssh/sshd_config
           if sshd -t > /dev/null 2>&1; then
             ufw allow "$P" > /dev/null 2>&1
             systemctl restart ssh > /dev/null 2>&1
             ok "Port SSH berhasil diubah → $P"
             warn "PENTING: Koneksi berikutnya gunakan port $P !"
           else
             cp "$SSHD_BAK" /etc/ssh/sshd_config
             err "Config SSH tidak valid! Dibatalkan, config dikembalikan."
           fi
           rm -f "$SSHD_BAK"; press_enter
         fi ;;
      3) read -rp "  Port Dropbear baru (misal: 109): " P
         if [[ ! "$P" =~ ^[0-9]+$ || "$P" -lt 1 || "$P" -gt 65535 ]]; then
           err "Port tidak valid!"; press_enter
         else
...
AKEOF
      ...
      9) if ! ls "$PANEL_DIR/backup/"*.tar.gz > /dev/null 2>&1; then
...
main_menu(){
  ...
  while true; do
    header
    echo -e "  ${D}╔════════════════════════════════════════════════════════╗${NC}"
    echo -e "  ${D}║${NC}  ${CB}◈  STATUS LAYANAN                                     ${D}║${NC}"
    echo -e "  ${D}╠══════════════════════════╦═════════════════════════════╣${NC}"
    printf "  ${D}║${NC}  ${D}%-20s${NC} %b    ${D}║${NC}  ${D}%-20s${NC} %b  ${D}║${NC}\n" "SSH/Dropbear"  "$(svc_stat ssh)"       "UDP Custom"   "$(svc_stat udp-custom)"
    ...
    echo -e "  ${D}╔══════════════════════════════╦═══════════════════════════════╗${NC}"
    echo -e "  ${D}║${NC}  ${CB}◈  MANAJEMEN AKUN          ${D}║${NC}  ${MB}◈  SISTEM & TOOLS             ${D}║${NC}"
    echo -e "  ${D}╠══════════════════════════════╬═══════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W} 1${R}]${NC} ${W}Manajemen SSH          ${D}║${NC}  ${M}[${W} 7${M}]${NC} ${W}Monitor Server          ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${O}[${W} 2${O}]${NC} ${W}Manajemen UDP Custom   ${D}║${NC}  ${GB}[${W} 8${GB}]${NC} ${W}Info Server & Port      ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${M}[${W} 3${M}]${NC} ${W}Manajemen ZIVPN UDP   ${D}║${NC}  ${B}[${W} 9${B}]${NC} ${W}Log & Riwayat           ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${Y}[${W} 4${Y}]${NC} ${W}Manajemen Xray        ${D}║${NC}  ${Y}[${W}10${Y}]${NC} ${W}Pengaturan + Tema       ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${D}      └ VMess/VLess/Trojan ${D}║${NC}  ${R}[${W}11${R}]${NC} ${W}Install Semua Layanan   ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${CB}[${W} 5${CB}]${NC} ${W}Kelola Service        ${D}║${NC}  ${D}[${W}12${D}]${NC} ${W}Info Sumber Binary      ${D}║${NC}"
    echo -e "  ${D}║${NC}  ${GB}[${W} 6${GB}]${NC} ${W}Speedtest VPS         ${D}║${NC}                               ${D}║${NC}"
    echo -e "  ${D}╠══════════════════════════════╩═══════════════════════════════╣${NC}"
    echo -e "  ${D}║${NC}  ${R}[${W} 0${R}]${NC} ${W}Keluar dari Panel                                      ${D}║${NC}"
    echo -e "  ${D}╚══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    read -rp "$(echo -e "  $(rainbow '❯') ${CB}Pilih Menu ${R}[${W}0-12${R}]${NC} : ")" MENU
